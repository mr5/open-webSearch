...
- `searchMode` may be provided per request and affects Bing; JD, Taobao, Alibaba/1688, Xiaohongshu, Zhihu, and X always require the external browser worker
...
- `--search-mode request|auto|playwright`
  ...
  - affects Bing; JD, Taobao, Alibaba/1688, Xiaohongshu, Zhihu, and X are always external-browser-only
