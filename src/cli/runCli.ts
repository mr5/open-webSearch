...
function formatCliHelp(): string {
    return [
        ...
        '    Search the web. `--search-mode` is request|auto|playwright and affects Bing; JD, Taobao, Alibaba/1688, Xiaohongshu, Zhihu, and X require BROWSER_BACKEND=external.',
